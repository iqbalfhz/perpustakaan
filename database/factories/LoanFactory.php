...
class LoanFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        $status = $this->faker->randomElement(['dipinjam', 'normal', 'hilang', 'rusak']);
        return [
            ...
            'returned_at' => in_array($status, ['normal','hilang','rusak']) ? $this->faker->dateTimeBetween($loaned, 'now')->format('Y-m-d H:i:s') : null,
            'status' => $status,
        ];
    }
}
